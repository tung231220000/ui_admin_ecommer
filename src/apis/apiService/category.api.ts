...
const CategoryRepository = {
  ...
  async fetchCategories(): Promise<GetCategoriesResponse> {
    const { data } = await apiBackend.get<GetCategoriesResponse>('/posts', {
    });

    return data;
  },
  async updateCategory(variables: UpdateCategoryPayload): Promise<UpdateCategoryResponse> {
    const { data } = await apiBackend.post<UpdateCategoryResponse>('/update-post', {
      variables,
    });
  ...
  async deleteCategory(variables: DeleteCategoryPayload): Promise<DeleteCategoryResponse> {
    const { data } = await apiBackend.post<DeleteCategoryResponse>('/delete-post', {
      variables,
    });
  ...
  async deleteManyCategories(
    ...
    const { data } = await apiBackend.post<DeleteManyCategoriesResponse>('/delete-posts', {
      variables,
    });
